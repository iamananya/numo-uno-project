 	...
 	<center><a  href="./img/cd-logo.svg" className="fb btn" alt="logo missing" style={{padding:"10px 12px"}}>
       ...
       <center><a  href="http://google.com/" className="twitter btn" style={{padding:"10px 12px"}}>
		...
		or</center></p> 
					...
					<center><p style={{fontSize:"14px" , fontFamily:"Montserrat"}}>No Account? <a href="javascript:toggleModalj()" style={{fontSize: "14px", fontFamily: "Montserrat"}}>Create One</a></p></center>
