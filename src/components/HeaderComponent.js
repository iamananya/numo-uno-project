    ...
    axios
      ...
      .catch((err) => {
        if (err.response.status === 400)
          ...
          console.log(
            "FRONTEND TEAM - SHOW unable to conect to server GIVEN BOLKE"
          );
  ...
  render() {
    return (
      <div className="keep-fixed">
            ...
            <Collapse isOpen={this.state.isNavOpen} navbar>
              <Nav className="ml-auto" navbar>
                ...
                <NavItem className="ml-5 ">
                  <div onClick={this.toggleModal} id="login">
                    {" "}
                    Login{" "}
                  </div>
                </NavItem>
        ...
        <Modal
          isOpen={this.state.isMdodalOpen}
          toggle={this.toggleModal}
          centered={true}
          centered={true}
          style={{ borderRadius: "15px", border: "0px", background: "white" }}
        >
            ...
            <center>
              ...
              >
                <form className="cd-signin-modal__form">
                  ...
                  <center>
                    <a href="./img/cd-logo.svg" className="fb btn">
                      <div className="b">
                        <p>.</p>
                      </div>
                      <div className="f">
                  ...
                  <p style={{ margin: "1em 0" }}>
                    <center>
                      <input
                        ...
                        onChange={(e) =>
                          this.setState({ instiEmail: e.target.value })
                        }
                        style={{
                          fontSize: "16px",
                          width: "80%",
