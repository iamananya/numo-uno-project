...
class Login extends Component {
    ...
    validate(telnum,loginEmail,loginPassword,){
        ...
        if (this.state.touched.loginEmail && this.state.loginEmail.split("").filter((x) => x === "@").length !== 1)
    ...
    render() {
        ...
        return(
                    ...
                    ,boxShadow: "0 0 6px rgba(0,0,0,.1)",width:"36%",backgroundColor:"white",marginTop:"3%"
                }}>			
